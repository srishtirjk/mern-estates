  ...
  return (
   ...
   <form onSubmit={handleSubmit} className="flex flex-col gap-8">
    <div className="flex items-center gap-2">
        ...
        <input  value={sidebardata.searchTerm}type='text' id='searchTerm' placeholder="Search...."
       onChange={handleChange}
       className="border rounded-lg p-3 w-full" name='searchTerm'/>
    </div>
...
{showMore &&(
  <button className='text-green-700 hover:underline p-7 texxt-center  w-full'onClick={onShowMoreClick}>
  show more  
  </button>
)}
       </div>
